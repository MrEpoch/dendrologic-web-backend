...
export default function Footer() {
  return (
    <footer className="bg-main-background-100">
      <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        ...
        <div className="border-t gap-8 flex justify-between items-center lg:pt-16">
          <div>
            <p className="font-medium text-gray-900">Informace</p>
