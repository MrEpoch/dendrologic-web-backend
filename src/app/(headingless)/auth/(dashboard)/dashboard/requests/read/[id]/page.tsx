...
export default async function Page({ params }) {
  const geoRequestData = await fetch((process.env.NODE_ENV === "development" ? "http://localhost:3752" : "https://dendrologic-web.stencukpage.com") + `/api/geojson/requests/${params.id}`, {
    method: "GET",
    headers: {
